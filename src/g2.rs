...
impl G2Affine {
    ...
    pub fn to_compressed(&self) -> [u8; 96] {
        ...
        let x = Fp2::conditional_select(&self.x, &Fp2::zero(), self.infinity.into());
    ...
    pub fn to_uncompressed(&self) -> [u8; 192] {
        ...
        let x = Fp2::conditional_select(&self.x, &Fp2::zero(), self.infinity.into());
        let y = Fp2::conditional_select(&self.y, &Fp2::zero(), self.infinity.into());
            ...
            D: Deserializer<'de>,
        {
            ...
            impl<'de> Visitor<'de> for G2AffineVisitor {
                ...
                fn expecting(&self, formatter: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
                    formatter
                        .write_str("a 48-byte cannonical compressed G2Affine point from Bls12_381")
                }
